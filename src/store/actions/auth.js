    ...
    return dispatch=>{
        ...
        axios.post(url,authData)
            .then(response=>{
                ...
                localStorage.setItem('expirationDate',expirationDate)                                           //gets the date and time the user is logged in
...
export const setAuthRedirectPath=(path)=>{
    return{
        type:actonTypes.SET_AUTH_REDIRECT_PATH,
        path:path
    }
}
